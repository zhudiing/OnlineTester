...
public:
  NamedValue(T value) : value_(value) {}
...
public:
  void setProperty(Name x) { name_ = x.get(); };
  void setProperty(Age x) { age_ = x.get(); };
  void setProperty(Title x) { title_ = x.get(); };
  void setProperty(Salary x) { salary_ = x.get(); };
  void setProperty(Department x) { department_ = x.get(); };
  void setProperty(Birth x) { birth_ = x.get(); };
